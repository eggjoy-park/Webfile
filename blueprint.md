...
*   **Weekly Weather Forecast:** Displays the 7-day weather forecast for a default location (Seoul). On desktop, it's a centered card layout. On mobile devices (under 768px), it becomes a horizontally-scrollable container, preventing layout breakage and improving usability. The date is now displayed directly next to the day of the week.
